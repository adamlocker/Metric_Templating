...
If the metric is calculated in any way, it should be made clear here, preferrably in plain language. Some more complex metrics may require mathematical notation, you shouldn't be afraid to use that if necessary. Credit the user with the gumption to understand it, but be prepared to rewrite it if you are asked to make it clearer. For example;
